# 归档：旧的 websocket 版 xfyun client
import sys
...
class XFYunClient:
    """归档：原始 xfyun websocket 客户端，实现保留以便回溯"""
    def __init__(self):
        self.app_id = XFYUN_CONFIG.get("app_id")
        self.api_key = XFYUN_CONFIG.get("api_key")
        self.api_secret = XFYUN_CONFIG.get("api_secret")
