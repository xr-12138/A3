...
# api_key = "Bearer yAYcJuoOoVHjXQJTWooD:BdHqiNwZrFWPeOEdEiaN"
# url = "https://spark-api-open.xf-yun.com/v1/chat/completions"
# model = "4.0Ultra"  # 可选：4.0Ultra、4.0、3.5等，具体请参考讯飞官方文档
api_key = "ollama"
url = "http://127.0.0.1:11434/v1/chat/completions"
model = "qwen3.5:2b"  # 可选：4.0Ultra、4.0、3.5等，具体请参考讯飞官方文档
# 请求模型，并将结果输出
